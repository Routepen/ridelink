...
function sendMail(options) {
  ...
  if (options.notifyDriver) {
    ...
    if (options.notifyDriver.routeCreated) {
      ...
      "<span>You're now apart of the team. We're here for you to help you make some serious money without worrying about last minute bailing! Now all you have to do is to post on the Fb Rideshare post with your link included. Keep in mind your route is only useful if you share it!</span><br/><br/>"+
